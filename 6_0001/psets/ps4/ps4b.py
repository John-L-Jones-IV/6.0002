...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        from string import whitespace, punctuation,\
                ascii_lowercase as s, ascii_uppercase as S
...
if __name__ == '__main__':
    ...
    #PlaintextMessage Test #1 - border case
    plaintext = PlaintextMessage('hello', 26)
    print('Expected Output: hello')
    print('Actual Output:', plaintext.get_message_text_encrypted())
    
    #PlaintextMessage Test #2 - border case 
    plaintext = PlaintextMessage('hello', 0)
    print('Expected Output: hello')
    print('Actual Output:', plaintext.get_message_text_encrypted())
    
    #PlaintextMessage Test #3 - normal case 
    plaintext = PlaintextMessage('MIT < GT', 1)
    print('Expected Output: NJU < HU')
    print('Actual Output:', plaintext.get_message_text_encrypted())

    #PlaintextMessage Test #4 - normal case 
    plaintext = PlaintextMessage('MIT < GT', 25)
    print('Expected Output: LHS < FS')
    print('Actual Output:', plaintext.get_message_text_encrypted())
